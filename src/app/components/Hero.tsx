...
function Hero() {
  ...
  return (
    <div className='w-full h-screen m-12 flex flex-col lg:flex-row mb-20 '>
        <div className='p-2 lg:w-3/5 w-full p-5'>
            <h1 className='text-4xl lg:text-7xl font-extrabold'>Your Image on a <span className='bg-green-500 rounded-lg text-white'>Custom</span> Phone Case</h1>
